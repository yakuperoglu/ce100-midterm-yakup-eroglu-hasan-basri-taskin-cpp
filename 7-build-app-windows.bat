...
call reportgenerator "-title:Bookshelforganizer Library Documentation Coverage Report (Windows)" "-reports:**/lcov_doxygen_lib_win.info" "-targetdir:docs/coverxygenlibwin" "-reporttypes:Html" "-filefilters:-*.md;-*.xml;-*[generated];-*build*" "-historydir:report_doc_lib_hist_win"
...
call reportgenerator "-title:Bookshelforganizer Library Test Documentation Coverage Report (Windows)" "-reports:**/lcov_doxygen_test_win.info" "-targetdir:docs/coverxygentestwin" "-reporttypes:Html" "-filefilters:-*.md;-*.xml;-*[generated];-*build*" "-historydir:report_doc_test_hist_win"
...
echo Generate Test Coverage Data for Bookshelforganizer
call OpenCppCoverage.exe --export_type=binary:bookshelforganizer_tests_unit_win.cov --sources src\bookshelforganizer\src --sources src\bookshelforganizer\header --sources src\tests\bookshelforganizer -- build_win\build\Debug\bookshelforganizer_tests.exe

echo Generate Test Coverage Data for Bookshelforganizer App and Combine Results
call OpenCppCoverage.exe --input_coverage=utility_tests_unit_win.cov --input_coverage=bookshelforganizer_tests_unit_win.cov --export_type=cobertura:bookshelforganizerapp_unit_win_cobertura.xml --sources src\utility\src --sources src\utility\header --sources src\bookshelforganizer\src --sources src\bookshelforganizer\header --sources src\bookshelforganizerapp\src --sources src\bookshelforganizerapp\header --sources src\tests\utility --sources src\tests\bookshelforganizer -- build_win\build\Debug\bookshelforganizerapp.exe

echo Generate Unit Test Coverage Report
call reportgenerator "-title:Bookshelforganizer Library Unit Test Coverage Report (Windows)" "-targetdir:docs/coveragereportlibwin" "-reporttypes:Html" "-reports:**/bookshelforganizerapp_unit_win_cobertura.xml" "-sourcedirs:src/utility/src;src/utility/header;src/bookshelforganizer/src;src/bookshelforganizer/header;src/bookshelforganizerapp/src;src/bookshelforganizerapp/header;src/tests/utility;src/tests/bookshelforganizer" "-filefilters:-*minkernel\*;-*gtest*;-*a\_work\*;-*gtest-*;-*gtest.cc;-*gtest.h;-*build*" "-historydir:report_test_hist_win"
call reportgenerator "-targetdir:assets/codecoveragelibwin" "-reporttypes:Badges" "-reports:**/bookshelforganizerapp_unit_win_cobertura.xml" "-sourcedirs:src/utility/src;src/utility/header;src/bookshelforganizer/src;src/bookshelforganizer/header;src/bookshelforganizerapp/src;src/bookshelforganizerapp/header;src/tests/utility;src/tests/bookshelforganizer" "-filefilters:-*minkernel\*;-*gtest*;-*a\_work\*;-*gtest-*;-*gtest.cc;-*gtest.h;-*build*"
...
call robocopy src\bookshelforganizer\header "build_win\build\Release" /E
call robocopy src\bookshelforganizerapp\header "build_win\build\Release" /E
...
call robocopy src\bookshelforganizer\header "build_win\build\Debug" /E
call robocopy src\bookshelforganizerapp\header "build_win\build\Debug" /E
